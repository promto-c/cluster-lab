  ...
  return (
    ...
    >
      <svg width="100%" height="100%" className="pointer-events-none">
        ...
        <text x="5" y={margin.top - 5} fill="#6b7280" fontSize="10">
          Max Dist: {displayMaxY.toFixed(2)}
        </text>
      ...
      <div className="absolute bottom-1 left-2 text-[10px] text-gray-500 pointer-events-none">Items: {nSamples}</div>
    </div>
  );
};
